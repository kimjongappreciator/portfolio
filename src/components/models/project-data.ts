...
export const financeData: ContentModel = {
  description: "montly_expenses_description",
...
export const threeDemoData: ContentModel = {
  description: "three_demo_description",
...
export const graphDemoData: ContentModel = {
  description: "graph_demo_description",
...
export const kanbanData: ContentModel = {
  description: "kanban_board_description",
